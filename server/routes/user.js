...
const { wxLogin, update_user, shopping_cart, delete_goods, add_item_to_cart, get_address, delete_address, add_address, update_address, get_orders, add_orders, done_order, delete_order } = require('../controllers/user')
